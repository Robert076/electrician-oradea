...
const MainServices = () => {
  return (
    <div className="services-page">
      {/* Hero Section */}
      <div className="services-hero" style={{ backgroundImage: "url('/hero.jpg')" }}>
        <div className="hero-overlay"></div>
        <div className="hero-content">
          <h1 className="services-title">Serviciile noastre</h1>
          <p className="services-subtitle">
            Soluții complete pentru toate nevoile tale electrice
          </p>
        </div>
      </div>
      ...
      <div className="services-container">
        ...
        <div className="services-cta">
          <div className="cta-content">
            ...
            <p className="cta-text">{SERVICIU_CALL_TO_ACTION}</p>
            <div className="cta-buttons">
              <a href="/contact" className="cta-btn primary">
                Solicită o ofertă
              </a>
              <a href="tel:0729914750" className="cta-btn secondary">
                Sună acum
              </a>
            </div>
          </div>
